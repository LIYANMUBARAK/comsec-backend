...
router.post("/inviteUser", async (req, res) => {
  try {
    ...
    await sendUserInvitationEmail(email, firstName, lastName, password);
...
router.get("/getInvitedUsers", async (req, res) => {
  try {
    const invitedUsers = await User.find({ is_Invited: true });
    
    // Transform the data to include firstName and lastName
...
router.patch("/update/:id", async (req, res) => {
  try {
    ...
    // Format the response to include split name fields
